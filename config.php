...
return [
  "display_errors" => false,
   "https" => true,
   "private_hash" => "49d8cdbabb5a9059c58e9d05b85c84e2",
   "private_hex" => "e88289ff6b9c9cea5bc47e9a7df9e96c",
   "feed_ads_key" => "84003698",
   "cron_key" => "61790562",
   "folder_admin" => "cp_6469cc0cab938",
   "basePath" => __dir__,
   "urlPrefix" => "/",
   "urlPath" => "https://autospot.ge",
   ...
   "template_folder" => "templates",
    ...
    "db" => [
     "port" => "",
     "host" => "localhost",
     "database" => "u162091693_autospotge",
     "user" => "u162091693_autospotgeo",
     "pass" => "Auto2023Spot!",
     "charset" => "utf8",
   ],
  ...
  "number_format" => [
   ...
   "media" => [
      ...
      "other" => "media/others",
      "car_logo" => "media/car_logo",
      "car_photos" => "media/car_photos",
      "car_body" => "media/car_body",
      "attach" => "media/attach",
   ...
   "css_styles" => [
      ...
      ['ad_create' => ['js/dragula/dragula.min.css','js/dropzone/dropzone.min.css',]],
      ['ad_update' => ['js/dragula/dragula.min.css','js/dropzone/dropzone.min.css',]],
      ['ad_view' => ['css/lightgallery.css',]],
      ['profile' => ['css/lightgallery.css',]],
      ['chat' => []],
      [
         'catalog' => [
            'js/slick/slick-theme.css',
   ...
   "js_plugins" => [
      ...
      ['ad_create' => ['js/create.js', 'js/dropzone/dropzone.min.js', 'js/jquery.ui.touch-punch.min.js', 'js/dragula/dragula.min.js', 'js/filter.js','js/Services_list.js']],
      ['ad_update' => ['js/create.js', 'js/dropzone/dropzone.min.js', 'js/jquery.ui.touch-punch.min.js', 'js/dragula/dragula.min.js', 'js/filter.js',]],
      ['ad_view' => ['js/view.js?v=8', 'js/order.js', 'js/footclothSlider.js', 'js/lightgallery.min.js', 'js/filter.js','js/Services_list.js']],
      ['profile' => ['js/user.js', 'js/delivery.js', 'js/lightgallery.min.js']],
      ['chat' => ['js/user.js']],
      ['catalog' => ['js/catalog.js', 'js/slick/slick.min.js', 'js/site-select.js',]],
      ['catalog_base' => ['js/catalog.js', 'js/site-select.js',]],
      ['blog' => ['js/blog.js']],
      ['blog_view' => ['js/blog.js']],
      ['index' => ['js/index.js', 'js/slick/slick.min.js']],
      ['map' => ['js/map.js']],
      ['order' => ['js/order.js']],
      ['buy' => ['js/order.js', 'js/delivery.js']],
      ['cart' => ['js/delivery.js']],
      ['order_booking' => ['js/order_booking.js']],
      ['shop' => ['js/shop.js', 'js/ckeditor5-inline/ckeditor.min.js', 'js/slick/slick.min.js', 'js/lightslider.min.js']],
      ['shops' => ['js/shops.js']],
   ...
   "sms_services" => [
        "gosms.ge" => [ "url" => "https://gosms.ge", "param" => "id", "country" => "Грузия" ],
