  ...
  "display_errors" => false,
   ...
   "video" => [
    ...
    "db" => [
     "port" => "",
     "host" => "localhost",
     "database" => "cc98525_autospot",
     "user" => "cc98525_autospot",
     "pass" => "&m%*uSat8qyJEURv",
     "charset" => "utf8",
   ],
   ...
   "css_styles" => [
      ...
      'css/bootstrap-5.min.css?v=154',
      'css/filter.css?v=442',
      'css/ionicons/ionicons.min.css',
      'css/styles.css?v=44422',
      'css/filters.css',
   ...
   "js_plugins" => [
    ...
    'js/popper.min.js',
    'js/popular-ad-grid.js?v=1002',
	'js/logo.js?v=13553474',
    'js/bootstrap.min.js',  
    'js/jquery.cookie.js',
    'js/owl-carousel/owl.carousel.min.js',
    'js/slick/slick.min.js?v=235444',
    'js/site-select.js',
    'js/vendor.js?v=1',
    'js/cart.js',
    'js/chat.js',
    ...
    [ 'ad_create'=> ['js/create.js?v=1','js/dropzone/dropzone.min.js','js/ui/jquery-ui.min.js','js/jquery.ui.touch-punch.min.js'] ],
    [ 'ad_update'=> ['js/create.js?v=1','js/dropzone/dropzone.min.js','js/ui/jquery-ui.min.js','js/jquery.ui.touch-punch.min.js'] ],
    [ 'ad_view'=> ['js/view.js','js/order.js','js/footclothSlider.js'] ],
    [ 'profile'=> ['js/user.js','js/delivery.js'] ],
    [ 'chat'=> ['js/user.js'] ],
    [ 'catalog'=> ['js/catalog.js?44'] ],
    [ 'blog'=> ['js/blog.js'] ],
    [ 'blog_view'=> ['js/blog.js'] ],
    [ 'index'=> ['js/index.js?v=12','js/stories.js','js/jquery.finger.min.js'] ],
    [ 'map'=> ['js/map.js'] ],
    [ 'order'=> ['js/order.js'] ],
