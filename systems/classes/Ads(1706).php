		...
		function generateAdsFilterItems($data) {
			...
			if (count($querys)) {
				foreach ($querys as $key => $value) {
					$output .= "
					<div class='col-lg-1 col-md-2 col-sm-2 col-3' style='text-align: center;'><a style='color: #283544; font-weight: 500;' href='" . _link($settings["country_default"]) . "/avtomobili/" . $value["ads_filters_items_alias"] . "'>
			...
			if (count($query)) {
				foreach ($query as $key => $value) {
					$output .= "<div class='col-lg-2 col-md-3 col-sm-3 col-6 mb20'><a style='color: #283544; font-weight: 500;' href='" . _link($settings["country_default"]) . "/avtomobili/" . $value["ads_filters_items_alias"] . "'>".$ULang->t( $value["ads_filters_items_value"] , [ "table" => "uni_ads_filters", "field" => "ads_filters_items_value" ] )."</a></div>";
				}
			}
			$output .= "</div>";
			$output .= "<script>
