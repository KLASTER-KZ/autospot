 ...
 Class Seo{
   ...
   if($param){
    ...
    $param_val = array(
      ...
      isset($data["auto"]["mark"]) ? $data["auto"]["mark"] : "",
      isset($data["auto"]["model"]) ? $data["auto"]["model"] : "",
      isset($data["auto"]["generation"]) ? $data["auto"]["generation"] : "",
      isset($data["auto"]["year-from"]) ? $data["auto"]["year-from"] : "",
      isset($data["auto"]["year-to"]) ? $data["auto"]["year-to"] : "",
      isset($data['auto']['complectation']) ? $data['auto']['complectation'] : ""
