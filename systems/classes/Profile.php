...
?>
								...
								<div class="module-chat-users-info">
									...
									<p class="module-chat-users-info-msg">
										...
										if ($getMsg["chat_messages_action"] == 0) {
											...
											if ($getMsg["chat_messages_id_user"] == $value["chat_users_id_user"]) {
												echo $ULang->t("Вы:") . ' ';
											}
									...
									<span class="module-chat-users-info-view">
										<div class="chat-users-info-read" <?php if ($getMsg["chat_messages_status"] && intval($_SESSION['profile']['id']) == $getMsg["chat_messages_id_user"]) {
																				echo 'style="display: block"';
																			} ?>><svg width="16" height="16" viewBox="0 0 16 16">
												<path fill="#77c226" fill-rule="evenodd" d="M11.226 3.5l.748.664-6.924 8.164L-.022 8.27l.644-.82 4.328 3.486L11.226 3.5zm4 0l.748.664-6.924 8.164-.776-.643.676-.749L15.226 3.5z"></path>
											</svg></div>
										<div class="chat-users-info-notread" <?php if (!$getMsg["chat_messages_status"] && intval($_SESSION['profile']['id']) == $getMsg["chat_messages_id_user"]) {
																					echo 'style="display: block"';
																				} ?>><svg width="16" height="16" viewBox="0 0 16 16">
												<path fill="#77c226" fill-rule="evenodd" d="M13.248 3.5l.748.664-6.924 8.164L2 8.215l.644-.765 4.328 3.486z"></path>
											</svg></div>
									</span>
	...
	function arrayMenu()
	{
		...
		$menu['services'] = ["name" => $ULang->t("Бизнес-услуги"), "icon" => '
            <svg fill="#000000" width="26px" height="26px" viewBox="0 0 24 24" id="lari" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg" class="icon flat-line"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path id="primary" d="M4,21H20m-8.5,0a7.5,7.5,0,1,1,7.35-9" style="fill: none; stroke: #000000; stroke-linecap: round; stroke-linejoin: round; stroke-width:0.696;"></path><path id="primary-2" data-name="primary" d="M9,12V3m4,9V3" style="fill: none; stroke: #000000; stroke-linecap: round; stroke-linejoin: round; stroke-width:0.696;"></path></g></svg>
		...
		$menu["statistics"] = ["link" => _link("user/" . $_SESSION["profile"]["data"]["clients_id_hash"] . "/statistics"), "icon" => '<svg height="24px" width="24px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-40.96 -40.96 593.92 593.92" xml:space="preserve" fill="#000000" stroke="#000000" stroke-width="0.00512"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <circle style="fill:#f73636;" cx="104.245" cy="379.15" r="27.732"></circle> <circle style="fill:#f73636;" cx="210.381" cy="214.894" r="27.732"></circle> <circle style="fill:#f73636;" cx="314.841" cy="297.016" r="27.732"></circle> <circle style="fill:#f73636;" cx="420.133" cy="123.33" r="27.732"></circle> </g> <path d="M9.002,110.422c4.662,0,8.44-3.778,8.44-8.44V8.44c0-4.662-3.778-8.44-8.44-8.44s-8.44,3.778-8.44,8.44v93.543 C0.563,106.643,4.34,110.422,9.002,110.422z"></path> <path d="M502.998,495.121H17.442v-359.38c0-4.662-3.778-8.44-8.44-8.44s-8.44,3.778-8.44,8.44v367.82c0,4.662,3.778,8.44,8.44,8.44 h493.996c4.662,0,8.44-3.778,8.44-8.44S507.66,495.121,502.998,495.121z"></path> <path d="M104.251,415.316c19.945,0,36.172-16.226,36.172-36.172c0-9.662-3.815-18.443-10.008-24.938l67.976-105.2 c3.757,1.326,7.793,2.054,11.997,2.054c8.46,0,16.244-2.928,22.412-7.813l49.181,38.67c-2.122,4.599-3.315,9.711-3.315,15.099 c0,19.945,16.226,36.172,36.172,36.172c19.945,0,36.172-16.226,36.172-36.172c0-10.035-4.111-19.126-10.733-25.686l68.838-113.553 c3.475,1.114,7.175,1.721,11.015,1.721c19.945,0,36.172-16.226,36.172-36.172s-16.226-36.172-36.172-36.172 s-36.172,16.226-36.172,36.172c0,10.035,4.111,19.126,10.733,25.686l-68.838,113.553c-3.475-1.114-7.175-1.721-11.015-1.721 c-8.461,0-16.246,2.928-22.413,7.813l-49.181-38.67c2.122-4.599,3.315-9.711,3.315-15.099c0-19.945-16.226-36.172-36.171-36.172 c-19.945,0-36.172,16.226-36.172,36.172c0,9.662,3.815,18.443,10.009,24.938l-67.976,105.2c-3.757-1.326-7.793-2.054-11.998-2.054 c-19.945,0-36.172,16.226-36.172,36.172C68.079,399.09,84.306,415.316,104.251,415.316z M420.127,104.036 c10.637,0,19.293,8.654,19.293,19.293c0,10.637-8.655,19.293-19.293,19.293c-10.637,0-19.293-8.654-19.293-19.293 C400.835,112.692,409.49,104.036,420.127,104.036z M334.128,297.017c0,10.637-8.655,19.293-19.293,19.293 c-10.637,0-19.293-8.655-19.293-19.293c0-10.637,8.655-19.293,19.293-19.293C325.472,277.726,334.128,286.38,334.128,297.017z M210.386,195.596c10.637,0,19.292,8.654,19.292,19.293c0,10.637-8.653,19.293-19.292,19.293c-10.637,0-19.293-8.654-19.293-19.293 C191.093,204.252,199.749,195.596,210.386,195.596z M104.251,359.853c10.637,0,19.293,8.655,19.293,19.293 c0,10.637-8.654,19.293-19.293,19.293c-10.637,0-19.293-8.655-19.293-19.293C84.958,368.507,93.613,359.853,104.251,359.853z"></path> </g></svg>', "name" => $ULang->t("Статистика")];
	...
	function payServiceCallBack($id_uniq = "")
	{
		...
		if ($getOrderParam) {
			...
			$service_data = json_decode($user['clients_data'], true);

			$id_ad = (int)$service_data["id_ad"];
			$id_s = (int)$service_data["id_s"];
			...
			$getAd = $Ads->get("ads_id=? and ads_id_user=?", [$id_ad, intval($output_param["id_user"])]);


			if (!$getService) {
				$error[] = $ULang->t("Пожалуйста, выберите услугу");
			}
			if (!$getAd) {
				$error[] = $ULang->t("Товар не найден");
			}
				
				$services_order_count_day = $getService["services_ads_count_day"];
				if ($id_s == 0) {
					$check1 = $service_data["tariffs_free-checkbox1"];
					$check2 = $service_data["tariffs_free-checkbox2"];
					$check3 = $service_data["tariffs_free-checkbox3"];
					$price = 0;
					if (isset($check1)) {
						$price += (int)$check1;
					}
				...
				$title = $getService["services_ads_name"] . " " . "на срок" . " " . $getService["services_ads_count_day"] . " " . ending($getService["services_ads_count_day"], "день", "дня", "дней");

				update("UPDATE uni_clients SET clients_data=? WHERE clients_id=?", ['',intval($output_param["id_user"])]);
			...
			$this->profileAddHistoryBalance(array("id_user"=>intval($output_param["id_user"]),"summa"=>$output_param["amount"],"title"=>$title,"id_order"=>generateOrderId()),"-");
		}
	}
