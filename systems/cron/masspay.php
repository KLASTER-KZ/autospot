   	   ...
   	   if($secure){
			...
			if($disputes){
				if($disputes["secure_disputes_status"] == 0){
					...
					actionVarPay( [ "clients_card_id"=>$user_seller["clients_card_id"],"clients_score"=>$user_seller["clients_score"],"total_amount"=>$value["secure_payments_amount"] - calcPercent( $value["secure_payments_amount"], $payment["secure_percent_service"] ),"secure_id"=>$secure["secure_id"],"secure_id_order"=>$secure["secure_id_order"],"payments_id"=>$value["secure_payments_id"], "amount" => $value["secure_payments_amount"], "id_ad" => $secure["secure_id_ad"], "id_user" => $user_seller["clients_id"], "user_name" => $user_seller["clients_name"], "id_hash_user" => $user_seller["clients_id_hash"], "secure_desc" => $static_msg["53"] ] );
