...
<html lang="<?php echo getLang(); ?>">
	...
	<body data-prefix="<?php echo $config["urlPrefix"]; ?>" data-template="<?php echo $config["template_folder"]; ?>" data-header-sticky="true" data-type-loading="<?php echo $settings["type_content_loading"]; ?>" data-page-name="<?php echo $route_name; ?>" >
		...
		<div class="col-lg-12 d-none d-lg-block" style="padding: 0px; margin-top:125px;"></div>
		...
		<div class="container" >
			...
			<div class="row" >
				...
				<div class="col-lg-12 min-height-600" >
					...
					<?php
						$outParent = $CategoryBoard->outParent($getCategoryBoard, [ "tpl_parent" => '<div class="col-lg-3 col-12 col-md-4 col-sm-4 mt30" ><a {ACTIVE} href="{PARENT_LINK}">{PARENT_NAME} {COUNT_AD}</a></div>', "tpl" => '{PARENT_CATEGORY}', "category" => $data["category"]]);
					?>
					...
					<div class="row" >
						...
						<div class="col-lg-12" >
							...
							<?php if( $data["vip"]["count"] && !$data["param_filter"]["filter"]["vip"] ){ ?>
								<div class="mb20" >
									<div class="mb25 title-and-link h4" style="margin-top:105px;"> <strong><?php echo $ULang->t( "VIP объявления" ); ?></strong> <a href="<?php echo $data["vip_link"]; ?>" ><?php echo $ULang->t( "Больше объявлений" ); ?> <i class="las la-arrow-right"></i></a> 
							...
							<div class="catalog-sort text-right mt60 mb10" >
