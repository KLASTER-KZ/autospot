...
<body data-prefix="<?php echo $config["urlPrefix"]; ?>" data-template="
			...
			<?php echo $Banners->out( ["position_name"=>"catalog_base_top"] ); ?>
				...
				<?php if($data['filter_found']) {?>
					...
					<form class="filters_base">
						...
						<button type="submit" id="filter_base">Применить </button>
					</form>
	...
	<div class="container" style="padding: 60px 0;">
		...
		<div class="h3 mb20">
			<strong class="title-and-link h4" style="font-size:30px; margin-bottom: 30px;">
				...
				- <br>Технические характеристики и комплектации
			</strong>
		</div>
		...
		<div class="complect_head">
			<div class="complect_head-td">Комплектации</div>
		</div>
		<div class="complect_table">
			<div class="complect_table-head">
				<div class="complect_table-head-td">Двигатель</div>
				<div class="complect_table-head-td">Привод</div>
				<div class="complect_table-head-td">Коробка</div>
			</div>
