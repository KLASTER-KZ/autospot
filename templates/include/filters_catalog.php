<?php
	if(($value["ads_filters_type"] == "select" || $value["ads_filters_type"] == "input_btn" || $value["ads_filters_type"] == "input_multi_btn" ||   $value["ads_filters_type"] == "input_btn_color" || $value["ads_filters_type"] == "input_checkbox" || $value["ads_filters_type"] == "switch_btn" || $value["ads_filters_type"] == "select_multi") && $value["ads_filters_id"] != 311){
		...
		}elseif($value["ads_filters_type"] == "input" || $value["ads_filters_id"] == 311){
		if(count($getItems) > 0){	
