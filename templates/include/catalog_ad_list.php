...
<div class="col-lg-12" >
	<div class="item-list <?php echo isset($service[2]) || isset($service[3]) ? "ads-highlight" : ""; ?>" title="<?php echo $value["ads_title"]; ?>">
		...
		<div class="row no-gutters" >
			...
			<div class="col-lg-9 col-sm-12 col-md-9 col-12" style="background: #fff;">
				<div class="item-list-content" >
					<div class="row" >
						<div class="col-lg-8 col-8" >
							<a  class="item-list-title word-break" href="<?php echo $Ads->alias($value); ?>">
								<?php
									$datas = custom_substr($value["ads_title"], 100, "...");
									$parts = explode(" ", $datas);
					...
					<div class="row mt20">
						<div class="col-lg-2 col-6 col-md-3 col-sm-6">
