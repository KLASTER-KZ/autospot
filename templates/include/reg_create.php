...
<div class="auth-block-tab auth-block-tab-auth auth-block-tab-2" >
    ...
    <input type="password"  class="form-control input-style2-custom" placeholder="<?php echo $ULang->t("Создайте пароль"); ?>" maxlength="25" name="user_pass">
    <div class="msg-error mb10" data-name="user_pass" ></div>  
    
    <div class="box-save-auth" style="display:none;">
      <label class="checkbox">
        <input type="checkbox" name="save_auth" value="1" checked>
        <span></span>
...
<!--
    ...
    <button class="button-style-custom schema-color-button css-ypypxs action-auth-send-create mt20" ><?php echo $ULang->t("Войти"); ?></button>
...
<div class="auth-block-tab auth-block-tab-reg auth-block-tab-1" >
    ...
    <div class="auth-block-right-box-tab-1-1" >
      ...
      <input type="text" id="number_reg-value" class="form-control input-style2-custom phone-mask" data-format="<?php echo getFormatPhone(); ?>" placeholder="<?php echo $ULang->t("Номер телефона"); ?>" name="user_login">
     ...
     <!-- <div class="auth-captcha" style="display: block;" >
      ...
      <button id="number_reg-value-click" class="button-style-custom schema-color-button css-i2yj1g action-reg-send mt20" ><?php echo $ULang->t("Продолжить"); ?></button>
    ...
    <div class="auth-block-right-box-tab-1-2" >
      ...
      <div class="number_reg" style="font-size:12px;padding-left:15px;"><?php echo $ULang->t("смс код отправлен на номер"); ?> <span style="font-weight: 900;"></span></div>
      <script>
        document.getElementById('number_reg-value-click').addEventListener('click', function(){
          document.querySelector('.number_reg span').innerHTML = document.getElementById('number_reg-value').value;
        })
      </script>
    ...
    <div class="auth-block-right-box-tab-1-3" >
      ...
      <button class="button-style-custom schema-color-button css-ypypxs action-reg-finish-create mt20" ><?php echo $ULang->t("Завершить регистрацию"); ?></button>           
    </div>
