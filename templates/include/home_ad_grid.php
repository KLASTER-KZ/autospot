<?php 
	...
	$ads_id = $value['ads_id'];
	$filters = ['312' => 'query_1','310' => 'query_2','314' => 'query_3',];
	...
	<div class="item-grid <?php echo isset($service[2]) || isset($service[3]) ? "ads-highlight" : ""; ?>" title="<?php echo $value["ads_title"]; ?>" >
		...
		<div class="item-grid-info" >
			...
			<div class="item-grid-price" >
				<!-- Блок с ценой в USD -->
				<div id="usdPriceBlock_<?php echo $value['ads_id']; ?>7">
					<?php
				...
				<div class="item-grid-price-now" id="lariPriceBlock_<?php echo $value['ads_id']; ?>7" style="display: none;">
	...
	<script>
		$(document).ready(function () {
			...
			if (selectedButton === 'lari') {
				$("#usdPriceBlock_<?php echo $value['ads_id']; ?>7").hide();
				$("#lariPriceBlock_<?php echo $value['ads_id']; ?>7").show();
				} else {
				$("#usdPriceBlock_<?php echo $value['ads_id']; ?>7").show();
				$("#lariPriceBlock_<?php echo $value['ads_id']; ?>7").hide();
			}
