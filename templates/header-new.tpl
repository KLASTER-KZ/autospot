    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-12 text-left" style="padding: 3px; margin-left: 4px;">
                ...
                <a href="/georgia/avtomobili" class="css-dfdre54 col-6">
                    <?php echo $ULang->t("Автомобили", ["table" => "uni_category_board", "field" => "category_board_name"]); ?>
                </a>

                <a href="/georgia/moto" class="css-dfdre54 col-6">
                    <?php echo $ULang->t("Мототехника", ["table" => "uni_category_board", "field" => "category_board_name"]); ?>
                </a>

                <a href="/georgia/avtobusy-i-gruzoviki" class="css-dfdre54 col-6">
                    <?php echo $ULang->t("Коммерческие", ["table" => "uni_category_board", "field" => "category_board_name"]); ?>
                </a>

                <a href="/georgia/carparts" class="css-dfdre54 col-6">
                    <?php echo $ULang->t("Разборные автомобили", ["table" => "uni_category_board", "field" => "category_board_name"]); ?>
                </a>

                <a href="/georgia/services" class="css-dfdre54 col-6">
                     <?php echo $ULang->t("Ремонт и услуги", ["table" => "uni_category_board", "field" => "category_board_name"]); ?>
                </a>

                <a href="/georgia/tires" class="css-dfdre54 col-6">
                    <?php echo $ULang->t("Шины и диски", ["table" => "uni_category_board", "field" => "category_board_name"]); ?>
                </a>

                <a href="/promo/razvivayte-biznes-na-autospot/" class="css-dfdre54">
                    <span class="css-ew23gww"><?php echo $ULang->t("Для бизнеса") ?></span>
                </a>
...
<?php } ?>
	...
	<header class="header-wow-mobile d-block d-lg-none <?php if( $route_name == "catalog" || $route_name == "auth" ){ echo ''; }else{ echo 'height55'; } ?>" <?php if($route_name == "map"){ echo 'style="margin-bottom:0px;"'; } ?> >
				...
				<div class="container" >
					<div class="header-flex-box" >   
						...
						<div class="header-flex-box-mobile-3" >
							...
							<?php if($route_name == "catalog" || $route_name == "auth" || $route_name == "ad_create"){ ?>
