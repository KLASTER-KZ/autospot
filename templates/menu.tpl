<div class="header-wow-top css-dasfwe d-none d-lg-block" style="margin-top:17px;">
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-12 text-left" style="padding: 3px; margin-left: 4px;">
				...
				?>
				<a href="/catalog/" class="css-dfdre54 col-6">
						<?php echo $ULang->t("Каталог"); ?>
				</a>
				<a href="<?php echo getLang() === 'rus' ? '/promo/razvivayte-biznes-na-autospot/' : '/promo/ganavitaret-biznesi-autospotze/' ?>" class="css-dfdre54">
                    <span class="css-ew23gww">
						<?php echo $ULang->t("Для бизнеса") ?>
					</span>
				</a>
			</div>
		</div>
