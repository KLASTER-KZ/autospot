$(document).ready(function () {
   ...
   $(document).on("click", ".warning-seller-safety-close", function (e) {
      ...
      document.cookie = `sellersafety=hide;${cookieOptions}`;
   });

   if (getCookie().sellersafety != "hide") {
   ...
   $('#user-form-avatar > input').on('change', function () {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: data_form, dataType: "json", cache: false, contentType: false, processData: false,
   ...
   $(document).on('click', '.profile-user-block', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id=" + $(this).data("id") + "&action=profile_user_locked", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('submit', '.form-balance', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: $(this).serialize() + "&lang=" + lang +"&action=balance_payment", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('submit', '.user-form-settings', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: $(this).serialize() + "&action=user_edit", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('click', '.user-edit-pass', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "user_current_pass=" + $("input[name=user_current_pass]").val() + "&user_new_pass=" + $("input[name=user_new_pass]").val() + "&action=user_edit_pass", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('click', '.user-edit-email', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "user_email=" + $("input[name=email]").val() + "&action=user_edit_email", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('click', '.user-edit-phone-send', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "phone=" + $("input[name=phone]").val() + "&action=user_edit_phone_send", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('click', '.user-edit-phone-save', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "code=" + $("input[name=code]").val() + "&phone=" + $("input[name=phone]").val() + "&action=user_edit_phone_save", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('change', '.modal-edit-notifications-content input', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: $(".form-edit-notifications").serialize() + "&action=user_edit_notifications", dataType: "html", cache: false, success: function (data) {
         }
      });
   ...
   $(document).on('click', '.user-edit-score', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "user_score=" + $("input[name=user_score]").val() + "&user_score_type=" + user_score_type + "&action=user_edit_score", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('click', '.user-edit-score-booking', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "user_score_booking=" + $("input[name=user_score_booking]").val() + "&action=user_edit_score_booking", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('click', '.user-delete-review', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id=" + id_review + "&action=delete_review", dataType: "html", cache: false, success: function (data) {
   ...
   $(document).on('click', '.profile-subscriptions-ad-delete', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id=" + $(this).data("id") + "&action=delete_ads_subscriptions", dataType: "html", cache: false, success: function (data) {
   ...
   $(document).on('click', '.profile-subscriptions-ad-period', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id=" + $(this).data("id") + "&period=" + $(this).data("period") + "&action=period_ads_subscriptions", dataType: "html", cache: false, success: function (data) {
   ...
   $(document).on('click', '.profile-subscriptions-shop-delete', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id=" + $(this).data("id") + "&action=delete_shop_subscriptions", dataType: "html", cache: false, success: function (data) {
   ...
   function attach_reviews(input) {
      ...
      $.ajax({
         url: url_path + "systems/ajax/profile.php", type: 'POST', data: data, cache: false, dataType: 'html', processData: false, contentType: false,
   ...
   $(document).on('submit', '.form-user-add-review', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: $(this).serialize() + "&action=add_review_user", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('click', '.profile-scheduler-delete', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id=" + $(this).data('id') + "&action=scheduler_ad_delete", dataType: "html", cache: false, success: function (data) {
   ...
   $(document).on('click', '.profile-ads-status-sell', function () {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/ads.php", data: "id_ad=" + change_id_ad + "&action=ads_status_sell", dataType: "html", cache: false, success: function (data) {
            location.reload();
         }
      });
   });
   ...
   $(document).on('click', '.profile-ads-remove-publication', function () {
      showLoadProcess($(this));
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/ads.php", data: "id_ad=" + change_id_ad + "&action=remove_publication", dataType: "html", cache: false, success: function (data) {
            location.reload();
         }
      });
   });
   ...
   $(document).on('click', '.profile-ads-delete', function () {
      showLoadProcess($(this));
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/ads.php", data: "id_ad=" + change_id_ad + "&action=ads_delete", dataType: "html", cache: false, success: function (data) {
            location.reload();
         }
      });
   });
   ...
   $(document).on('click', '.statistics-load-info-user', function () {
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id=" + $(this).data('id') + "&action=statistics_load_info_user", dataType: "html", cache: false, success: function (data) {
   ...
   $(document).on('click', '.profile-init-add-card', function () {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id=" + $(this).data('id') + "&action=profile_add_card", dataType: "json", cache: false, success: function (data) {
            if (data['status'] == true) {
   ...
   $(document).on('click', '.profile-init-delete-card', function () {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id=" + $(this).data('id') + "&action=profile_delete_card", dataType: "json", cache: false, success: function (data) {
            if (data['status'] == true) {
               location.reload();
            } else {
               alert(data['answer']);
   ...
   $(document).on('click', '.user-requisites-save', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: $('.user-requisites-form').serialize() + "&action=user_requisites_edit", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('submit', '.form-balance-invoice', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: $(this).serialize() + "&action=balance_invoice", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('click', '.modal-booking-calendar-cancel-date', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id_ad=" + $(this).data('id-ad') + "&date=" + $(this).data('date') + "&action=cancel_date_booking_calendar", dataType: "json", cache: false, success: function (data) {
   ...
   $(document).on('click', '.modal-booking-calendar-allow-date', function (e) {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id_ad=" + $(this).data('id-ad') + "&date=" + $(this).data('date') + "&action=allow_date_booking_calendar", dataType: "json", cache: false, success: function (data) {
   ...
   function loadBookingOrdersDate() {
      ...
      $.ajax({
         type: "POST", url: url_path + "systems/ajax/profile.php", data: "id_ad=" + $('.booking-calendar-input-change-ad').val() + "&action=load_orders_date_booking_calendar", dataType: "json", cache: false, success: function (data) {
            ...
            $(".profile-booking-calendar").datepicker({
               onSelect: function (date) {
                  ...
                  $.ajax({
                     type: "POST", url: url_path + "systems/ajax/profile.php", data: "id_ad=" + $('.booking-calendar-input-change-ad').val() + "&date=" + date + "&action=load_orders_booking_calendar", dataType: "html", cache: false, success: function (data) {
