		...
		<div class="container" >
			...
			<?php
				...
				if ($result_check->num_rows == 0) {
					...
					$ads_img = Exists($config["media"]["small_image_ads"], $data["ad"]["ads_images"][0], $config["media"]["no_image"]);
					...
					<div class="d-none d-xl-block" >
						...
						<nav aria-label="breadcrumb" >
							...
							<ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
								...
								?>
								<div id="category_id-board" style="display: none;"><?php echo $data["ad"]["category_board_id"]; ?></div>                 
							</ol>
						...
						<div class="row" >
							<div class="col-lg-10 col-12" >
								<h1 class="h1title word-break" >
								<?php
                                 $datas = $data["ad"]["ads_title"];
                                 $parts = explode(" ", $datas);
					...
					<div class="row" >
						...
						<div class="col-lg-9" >
							...
							<div class="d-block d-lg-none" >
								...
								<h1 class="h1title word-break" ><?php
                                 $datas = $data["ad"]["ads_title"];
                                 $parts = explode(" ", $datas);
                                 for ($i = 0; $i <= min(count($parts), 100); $i++) {
                                 echo '<span class="tag' . $i . '"> '.$ULang->t($parts[$i], ["table" => "uni_ads_filters", "field" => "ads_filters_items_value"]).' </span>';
								...
								<div class="price_box" style="display: flex; align-items: center;gap: 20px;">
									<?php echo $Ads->outAdViewPrice( ["data" => $data["ad"]] ); ?>
									<div id="inf_customs" class="inf_customs"></div>
                                     ...
                                     <div id="board-view-sidebar-mobile-box">
							...
							<?php if($data["ad"]["ads_text"]){ ?>
								...
								<div class="word-break ff-1 fs16 mb20" ><?php echo nl2br($data["ad"]["ads_text"]); ?> </div>
...
?>
							<?php
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="padding:10px;">
									...
									<br>
									<span class="css-asfw343"><span style="color: #fff;">.</span><?php
                                    if ($min_price > 0) {
                                        echo $ULang->t("Мин ") . number_format($min_price, 0, '.', ',') . "$";
                                    }
                                    ?>
                                    </span>
									...
									<div class="price-range-container">
										...
										<div class="price-range-slider">
											<div class="price-text auto-label">
                                                ...
                                                <?php
                                                if (isset($data["ad"]["ads_price_usd"]) && $data["ad"]["ads_price_usd"] > 0) {
                                                 echo number_format($data["ad"]["ads_price_usd"], 0, '.', ',') . "$";
                                                } else {
                                                echo $ULang->t("");
                                                }
                                                ?>
...
?>
                            ...
                            <div class="board-view-user-mobile mt20 d-lg-none" >
                            ...
                            <div data-id-modal="modal-complaint" class="d-none d-lg-block complain-toggle open-modal mt10 init-complaint" data-id="<?php echo $data["ad"]["ads_id"]; ?>" data-action="ad" > <span><?php echo $ULang->t("Пожаловаться"); ?></span> </div>
		...
		<div class="share_expert-box d-block d-lg-none" style="margin-top:50px;">
										<div id="share_expert-calc-height1" class="share_expert-calc-height"></div>
										<div id="share_expert-calc1" class="share_expert-calc">
												...
												<div class="country_price country_price-open" style="position:relative;cursor:pointer;">
													...
													<div id="country_price-text1" class="country_price-text"> <?php echo $ULang->t("Выберите страну"); ?></div>
		...
		<noindex>
			...
			<div class="modal-custom-bg bg-click-close" style="display: none;" id="modal-view-phone" >
				<div class="modal-custom animation-modal" style="max-width: 400px;" >
					...
					<div class="phone_modal" style="display: flex; flex-direction: column; align-items: center; gap: 10px;">
						<div class="modal-view-phone-display"></div>
						<div class="modal-view-phone-display-wathsapp">
							<?php 
								$url_wat = ((!empty($_SERVER['HTTPS'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] .'/'. $_SERVER['REQUEST_URI'];
								$url_wat_encode = urlencode($url_wat)
							?>
							<div id="url_wat_encode" style="display: none;"><?php echo $url_wat_encode; ?></div>
							<a id="modal-view-phone-display-wathsapp" target="_blank" href="#" onclick="document.getElementById('modal-view-phone-display-wathsapp').href = `https://wa.me/${document.querySelector('.modal-view-phone-display a').innerHTML.replace('+' , '')}?text=${document.getElementById('url_wat_encode').innerHTML}`">
								<img src="/media/others/wathsapp_share-expert.svg" alt="wb">
							</a>
						</div>
					</div>
			...
			<div id="board-view-sidebar-mobile" class="d-block d-lg-none">
