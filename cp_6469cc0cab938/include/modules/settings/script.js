$(document).ready(function () {
    ...
    $('.settings-edit-email-template').click(function () {
        ...
        $.ajax({
            type: "POST", url: "include/modules/settings/handlers/edit_email_tpl.php", data: data_form, dataType: "html", cache: false, contentType: false, processData: false,
            success: function (data) {
                $('.proccess_load').hide();
                notification();
            }
    ...
    $(document).on("change", ".change-payment", function () {
        ...
        $.ajax({
            type: "POST", url: "include/modules/settings/handlers/load_payment.php", data: "code=" + code, dataType: "html", cache: false,
            success: function (data) {
                $('.proccess_load').hide();
                notification();
    ...
    $('.sort-container').sortable({
        ...
        stop: function () {
            ...
            $.ajax({
                url: "include/modules/settings/handlers/sorting_lang.php", type: 'POST', data: { arrays: arr },
                success: function (data) {
                    notification();
                }
            });
    ...
    $(document).on("click", ".delete-calc", function () {
        var uid = $(this).attr("data-id");
        ...
        swal({
            ...
            if (result.value) {
                $('.proccess_load').show();
                $.ajax({
                    type: "POST", url: "include/modules/settings/handlers/delete_calc.php", data: "id=" + uid, dataType: "html", cache: false,
                    success: function (data) {
                        $('.proccess_load').hide();
                        if (data == true) {
                            location.reload();
    ...
    $(document).on("click", ".add-calc", function () {

        var data_form = new FormData($('.form-add-calc')[0]);

        $('.proccess_load').show();

        $.ajax({
            type: "POST", url: "include/modules/settings/handlers/add_calc.php", data: data_form, dataType: "html",
    ...
    $(document).on("click", ".edit-calc", function () {

        var data_form = new FormData($('.form-edit-calc')[0]);

        $('.proccess_load').show();

        $.ajax({
            type: "POST", url: "include/modules/settings/handlers/edit_calc.php", data: data_form, dataType: "html",
            cache: false, contentType: false, processData: false, success: function (data) {
                console.log(data);
    ...
    $(document).on('click', '.load_edit_calc', function () {
        var data_id = $(this).attr("data-id");
        $.ajax({
            type: "POST", url: "include/modules/settings/handlers/load_edit_calc.php", data: "id=" + data_id, dataType: "html", cache: false,
            success: function (data) {
                $('.proccess_load').hide();
                $('.form-edit-calc').html(data);
                $('#modal-edit-calc').modal("show");
            }
        });
    });
    ...
    $(document).on('click', '.load_edit_lang', function () {
        var data_id = $(this).attr("data-id");
        $.ajax({
            type: "POST", url: "include/modules/settings/handlers/load_edit_lang.php", data: "id=" + data_id, dataType: "html", cache: false,
            success: function (data) {
                $('.proccess_load').hide();
    ...
    $(document).on('click', '.test-payment', function () {
        ...
        $.ajax({
            type: "POST", url: "include/modules/settings/handlers/test_payment.php", data: "payment=" + name, dataType: "json", cache: false,
            success: function (data) {
                console.log(data);
                if (data["link"]) {
    ...
    $(document).on("change", "select[name=secure_payment_service_name]", function () {
        ...
        $.ajax({
            type: "POST", url: "include/modules/settings/handlers/load_payment_secure.php", data: "code=" + code, dataType: "html", cache: false,
            success: function (data) {
                $('.proccess_load').hide();
                notification();
