$(document).ready(function() {
    ...
    $(document).on('click','.load_edit_services_category', function (e) {  
        var data_id = $(this).attr("data-id");    
            $('.proccess_load').show(); 
            $.ajax({
                type: "POST",url: "include/modules/services_ad/handlers/load_edit_category.php",data: "id="+data_id,dataType: "html",cache: false,                                                
                success: function (data) {
                    $('.proccess_load').hide();
                    $(".form-category-edit").html(data);
    ...
    $(document).on('click','.board-edit-category', function (e) {
        var data_form = new FormData($('.form-category-edit')[0]);     
        $('.proccess_load').show(); 
        $.ajax({
            type: "POST",url: "include/modules/services_ad/handlers/edit_category.php",data: data_form,dataType: "html",cache: false,contentType: false,processData: false,                                                
            success: function (data) {
                $('.proccess_load').hide();
                notification();              
            }
