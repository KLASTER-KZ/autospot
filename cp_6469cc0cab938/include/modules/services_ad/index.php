      ...
      <div class="widget has-shadow">
         <div class="widget-body">
            ...
            <ul class="nav nav-tabs nav-fill" role="tablist">
              ...
              <li class="nav-item">
                 <a class="nav-link <?php if($_GET["tab"] == "category"){ echo 'show active'; } ?>" id="just-tab-3" data-toggle="tab" href="#j-tab-3" role="tab" aria-controls="j-tab-3" aria-selected="false">Категории услуг</a>
              </li>                                                                             
            </ul>
            ...
            <div class="tab-content pt-4">
                ...
                <div class="tab-pane fade <?php if($_GET["tab"] == 'services'){ echo 'show active'; } ?>" id="j-tab-3" role="tabpanel" aria-labelledby="just-tab-3">

                     <div class="table-responsive">

                          <?php
                             $get = getAll("SELECT * FROM uni_services_ads_category order by id asc");     
                                 ...
                                 ?>
                                  ...
                                  <tr id="item<?php echo $value["services_ads_id"]; ?>" >
                                      ...
                                      <td>
                                        ...
                                        <?php echo $Main->outPrices( array("new_price"=> array("price"=>$value["new_price"], "tpl"=>'<span class="span_newPrice" >{price}</span>'), "price"=>array("price"=>$value["price"], "tpl"=>'<span class="span_oldPrice" >{price}</span>') ) ); ?>

                                      </td>

                                      <td class="td-actions" style="text-align: right;" >
                                       <a href="#" class="load_edit_services_category" data-id="<?php echo $value["id"]; ?>" ><i class="la la-edit edit"></i></a>
                                      </td>                          
                                  </tr> 
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-body">
               ...
               <form method="post" class="form-category-edit" >
               </form>

         </div>
         <div class="modal-footer">
            <button type="button" class="btn btn-shadow" data-dismiss="modal">Закрыть</button>
            <button type="button" class="btn btn-primary board-edit-category">Сохранить</button>
         </div>
      </div>
   </div>
</div>
