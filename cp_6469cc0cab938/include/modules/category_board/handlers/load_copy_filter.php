  ...
  <div class="col-lg-9">
      <select class="filter-list-cat-select selectpicker" name="type_filter" >
        ...
        <option value="select_multi" <?php if($getFilter->ads_filters_type == "select_multi"){ echo 'selected=""'; } ?> >Выпадающий список с множественным выбором</option>
       	<option value="input_btn" <?php if($getFilter->ads_filters_type == "input_btn"){ echo 'selected=""'; } ?> >Кнопки с одиночным выбором Да | Нет</option>
		<option value="input_multi_btn" <?php if($getFilter->ads_filters_type == "input_multi_btn"){ echo 'selected=""'; } ?> >Кнопки с множественным выбором</option>
		<option value="input_btn_color" <?php if($getFilter->ads_filters_type == "input_btn_color"){ echo 'selected=""'; } ?> >Кнопки выбора цвета</option>
		<option value="switch_btn" <?php if($getFilter->ads_filters_type == "switch_btn"){ echo 'selected=""'; } ?> >Переключатель</option>
		<option value="input_checkbox" <?php if($getFilter->ads_filters_type == "input_checkbox"){ echo 'selected=""'; } ?> >Чекбокс</option>
