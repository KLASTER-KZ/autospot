        ...
        if(!empty($filters['id_parent'])){               
           foreach($filters['id_parent'][$parent_id] as $value){
              ...
              if($value["ads_filters_type"] == "select"){
			   ...
			   if( ($value["ads_filters_type"] == "select" || $value["ads_filters_type"] == "input_btn") && !$value["ads_filters_id_parent"] && $list_category ){
			  ...
			  if( ($value["ads_filters_type"] == "select" || $value["ads_filters_type"] == "input_multi_btn") && !$value["ads_filters_id_parent"] && $list_category ){
                  $edit_alias = '<a href="#" class="action-load-alias-filter" data-id="'.$value["ads_filters_id"].'" data-toggle="modal" data-target="#modal-alias-filters" title="Алиасы фильтра" ><i class="la la-filter edit"></i></a>';
              }else{
                  $edit_alias = '';
              }
			  
			  if( ($value["ads_filters_type"] == "select" || $value["ads_filters_type"] == "switch_btn") && !$value["ads_filters_id_parent"] && $list_category ){
                  $edit_alias = '<a href="#" class="action-load-alias-filter" data-id="'.$value["ads_filters_id"].'" data-toggle="modal" data-target="#modal-alias-filters" title="Алиасы фильтра" ><i class="la la-filter edit"></i></a>';
              }else{
                  $edit_alias = '';
              }
			  
			  if( ($value["ads_filters_type"] == "select" || $value["ads_filters_type"] == "input_btn_color") && !$value["ads_filters_id_parent"] && $list_category ){
                  $edit_alias = '<a href="#" class="action-load-alias-filter" data-id="'.$value["ads_filters_id"].'" data-toggle="modal" data-target="#modal-alias-filters" title="Алиасы фильтра" ><i class="la la-filter edit"></i></a>';
              }else{
                  $edit_alias = '';
              }
			  
			   if( ($value["ads_filters_type"] == "select" || $value["ads_filters_type"] == "input_checkbox") && !$value["ads_filters_id_parent"] && $list_category ){
                  $edit_alias = '<a href="#" class="action-load-alias-filter" data-id="'.$value["ads_filters_id"].'" data-toggle="modal" data-target="#modal-alias-filters" title="Алиасы фильтра" ><i class="la la-filter edit"></i></a>';
              }else{
                  $edit_alias = '';
              }
