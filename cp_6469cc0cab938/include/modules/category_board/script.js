$(document).ready(function() {
    ...
    $(document).on('click','.small-image-delete1', function () {    
        $(this).parent().find(".image_delete").val("1");
        $(this).parent().find("img").attr("src", $("body").data("media-other") + "/icon_photo_add.png" );
        $(this).parent().find('.input-img1').val('');
        $(this).hide();
    });

    $(document).on('click','.change-img1', function () { $(this).parent().find('.input-img1').click(); });
    $(document).on('change','.input-img1', function () {    
        fileReader(this,  $(this).parent().find('.change-img1'), "60px");
        console.log($(this).value)
        $(this).parent().find(".small-image-delete1").show();
