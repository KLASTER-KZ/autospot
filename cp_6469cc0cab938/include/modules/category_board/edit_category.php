         ...
         <div class="widget-body">
            ...
            <form class="form-data" >
              ...
              <div class="category-block-conditional-online-view" >
                ...
                <div class="form-group row d-flex align-items-center">
                  <label class="col-lg-3 form-control-label">Не отображать карту</label>
                  <div class="col-lg-6">
                      <label class="mb0" >
                        <input class="toggle-checkbox-sm" type="checkbox" name="maps_view" <?php if($array_data->category_board_status_maps){ echo 'checked=""'; } ?> value="1" >
                        <span><span></span></span>
                      </label>
                  </div>
                </div>
