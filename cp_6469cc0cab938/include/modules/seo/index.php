         ...
         <div class="widget-body">
          ...
          <div class="row" >
            ...
            <div class="col-lg-3" >
              ...
              <li class="nav-item">
              <a class="nav-link" id="tab-7" data-toggle="tab" href="#tab-content-7" role="tab" aria-controls="tab-7" aria-selected="true">Каталог Автомобилей</a>
              </li> 
              <li class="nav-item">
              <a class="nav-link" id="tab-8" data-toggle="tab" href="#tab-content-8" role="tab" aria-controls="tab-8" aria-selected="true">Карточка каталога</a>
              </li>                         
              </ul>
                ...
                <div class="tab-content pt-3">
                  ...
                  <div class="tab-pane fade" id="tab-content-3" role="tabpanel" aria-labelledby="tab-3">
                    ...
                    <div class="seo-block-makros" >
                      ...
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Цена в $" >{ad_price_usd}</span>
                  ...
                  <div class="tab-pane fade" id="tab-content-7" role="tabpanel" aria-labelledby="tab-7">
                    ...
                    <div class="seo-block-makros" >
                      <p><strong>Данные для подстановки</strong></p>
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Название домена (dev.autospot.ge)" data-original-title="" title="">{domen}</span>
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Название проекта (AUTOSPOT.GE)" data-original-title="" title="">{site_name}</span>
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Ссылка на сайт (https://dev.autospot.ge)" data-original-title="" title="">{url}</span>
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Страна посетителя" data-original-title="" title="">{country}</span>
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Марка авто" >{auto-mark}</span>
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Модель авто" >{auto-model}</span>
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Год начала выпуска" >{auto-year-from}</span>
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Год конца выпуска" >{auto-year-to}</span>                      
                      <span data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Номер комплектации" >{auto-complectation}</span> 
                    </div>


                    <div class="form-group" >
                     <label class="form-control-label" >Заголовок страницы (Meta Title)</label>
                        <input type="text" class="form-control" id="catalog_base-meta_title" value="<?php echo $array_data["catalog_base"]["meta_title"]; ?>" name="form[catalog_base][meta_title]" />
                    </div>
                    <div class="form-group" >
                     <label class="form-control-label" >Meta Description</label>
                        <textarea class="form-control" id="catalog_base-meta_desc" name="form[catalog_base][meta_desc]" ><?php echo $array_data["catalog_base"]["meta_desc"]; ?></textarea> 
                    </div>
                  ...
                  <div class="tab-pane fade" id="tab-content-8" role="tabpanel" aria-labelledby="tab-8">
                    ...
                    <div class="form-group" >
                     <label class="form-control-label" >Заголовок страницы (Meta Title)</label>
                        <input type="text" class="form-control" id="catalog_base-meta_title" value="<?php echo $array_data["catalog_base_model"]["meta_title"]; ?>" name="form[catalog_base_model][meta_title]" />
                    </div>
                    <div class="form-group" >
                     <label class="form-control-label" >Meta Description</label>
                        <textarea class="form-control" id="catalog_base-meta_desc" name="form[catalog_base_model][meta_desc]" ><?php echo $array_data["catalog_base_model"]["meta_desc"]; ?></textarea> 
                    </div>
