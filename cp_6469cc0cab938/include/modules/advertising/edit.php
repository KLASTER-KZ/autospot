         ...
         <div class="widget-body">
            ...
            <form class="form-data" >
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                ...
                <?php
              //  eho($array_data->advertising_lang);
                ?>
                <div class="form-group row d-flex align-items-center mb-5">
                    <label class="col-lg-3 form-control-label">Язык баннера</label>
                    <div class="col-lg-9">
                        <select name="lang" class="selectpicker" >

                            <option value="all" <?php if($array_data->advertising_lang == 'all'){echo 'selected';}?>>Все языки</option>
                            <?php
                            $get = getAll("SELECT * FROM uni_languages order by id_position asc");
                            if (count($get) > 0)
                            {
                                foreach($get AS $array_datas){
                                    if($array_data->advertising_lang == $array_datas["iso"]){ $active = 'selected=""'; }else{ $active = ''; }
                                    echo '<option '.$active.' value="'.$array_datas["iso"].'" >'.$array_datas["name"].'</option>';
                                }
                            }
                            ?>
                        </select>
                ...
                <div class="form-group row d-flex align-items-center mb-5">
                    <label class="col-lg-3 form-control-label">Показ баненера, моб/пк</label>
                    <div class="col-lg-9">
                        <select name="tech" class="selectpicker" > 
                            <option value="pk"  <?php if($array_data->advertising_tech == 'pk'){echo 'selected';}?>>Компьютеры</option>
                            <option value="mob" <?php if($array_data->advertising_tech == 'mob'){echo 'selected';}?>>Мобильные телефоны</option>
