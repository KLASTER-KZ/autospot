                          ...
                          $lang =  $value["advertising_lang"];
                            ?>
                             ...
                             <tr>
                                 ...
                                 <td><?php if( $value["advertising_lang"] == 'all') { echo 'Все языки';}else{ echo getOne("SELECT * FROM uni_languages WHERE iso='$lang'")['name'];} ?></td>
                                 <td><?php
                                     if( $value["advertising_tech"] == 'pk') {
                                         echo 'Компьютеры';
                                     }elseif($value["advertising_tech"] == 'mob'){
                                         echo 'Моб. телефоны';
                                     }else{
                                         echo 'Все устройства';
                                     }
