...
if (count($error) == 0) {
      ...
      update("UPDATE uni_sliders SET sliders_image=?,sliders_link=?,sliders_title1=?,sliders_title2=?, sliders_color_bg=?,sliders_lang=? WHERE sliders_id=?", array( $data["sliders_image"],clear($_POST["link"]),clear($_POST["title1"]),clear($_POST["title2"]),clear($_POST["color"]),clear($_POST["sliders_lang"]),intval($_POST["id"]) ));        
