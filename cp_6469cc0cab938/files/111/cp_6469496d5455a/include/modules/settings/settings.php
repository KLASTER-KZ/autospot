...
<div class="widget has-shadow">
   ...
   <div class="widget-body">
      ...
      <div class="tab-content pt-3">
         ...
         <div class="tab-pane fade <?php if($_GET["tab"] == "app_settings"){ echo 'active show'; } ?>" id="j-tab-17" role="tabpanel" aria-labelledby="just-tab-17">
                           ...
                           ?>
                            <div id="ads" >
                               <span class="settings-widget-sorting-move" >
                                 ...
                                 <div class="form-check">
                                   <input class="form-check-input" type="checkbox" name="app_widgets_home_tabs[ads]" value="1" id="flexCheckAds" <?php if($check == 1){ echo 'checked=""'; } ?> >
