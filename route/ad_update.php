...
<div class="col-lg-6">
  <div class="input-dropdown">
    <input type="text" name="ads_price_usd" placeholder="'.$field_price_name.'" class="ads-create-input" maxlength="11" value="'.$data["ads_price_usd"].'" oninput="calculatePrice()">
    <div class="input-dropdown-box">
      <div class="uni-dropdown-align">
...
<div class="col-lg-6">
  <div class="input-dropdown">
    <input type="text" name="price" '.($data["ads_price_free"] ? 'disabled=""' : '').' placeholder="'.$field_price_name.'" value="'.number_format($data["ads_price"], 2, ".", " ").'" class="ads-create-input" maxlength="11" oninput="updateAdsPrice()">
